...
export const WEEKLY_GROUPS_ACCELERATED_CARS = [
...
export const WEEKLY_GROUPS_ACCELERATED_BIRDS = [
    "EAGLE", "FALCON", "HAWK", "OWL", "SPARROW", "ROBIN", "SWALLOW", "HERON",
    "KINGFISHER", "PEACOCK", "CRANE", "OSPREY", "PARROT", "TOUCAN", "FINCH",
    "WREN", "MAGPIE", "PELICAN", "STORK", "CARDINAL",
    "ORIOLE", "MOCKINGBIRD", "WOODPECKER", "FLAMINGO", "PUFFIN"
];

export const WEEKLY_GROUPS_ACCELERATED_FISH = [
    "SALMON", "TUNA", "TROUT", "BASS", "CATFISH", "COD", "HALIBUT", "MACKEREL",
    "SNAPPER", "TILAPIA", "MARLIN", "SWORDFISH", "ANCHOVY", "SARDINE", "HERRING",
    "GROUPER", "MULLET", "PERCH", "CARP", "EEL",
    "STINGRAY", "BARRACUDA", "MAHIMAHI", "POMPANO", "FLOUNDER"
];

export const WEEKLY_GROUPS_ACCELERATED_BUTTERFLIES = [
    "MONARCH", "SWALLOWTAIL", "PAINTEDLADY", "ADMIRAL", "SULPHUR", "COPPER",
    "SKIPPER", "FRITILLARY", "HAIRSTREAK", "MORPHO", "LUNAMOTH", "ATLASMOTH",
    "CABBAGEWHITE", "BUCKEYE", "VICEROY", "QUESTIONMARK", "COMMA", "CRESCENT",
    "METALMARK", "DUKE", "GLASSWING", "PEACOCK2", "BRIMSTONE", "CLOUDLESS", "ZEBRA"
];

export const WEEKLY_GROUPS_ACCELERATED_DOG_BREEDS = [
    "LABRADOR", "BEAGLE", "POODLE", "BULLDOG", "BOXER", "HUSKY", "COLLIE",
    "DACHSHUND", "CHIHUAHUA", "POMERANIAN", "ROTTWEILER", "DALMATIAN", "SHEPHERD",
    "TERRIER", "SPANIEL", "MASTIFF", "GREYHOUND", "SCHNAUZER", "SHIHTZU", "PUG",
    "AKITA", "CORGI", "SAMOYED", "WHIPPET", "SETTER"
];

export const WEEKLY_GROUPS_ACCELERATED_MOUNTAINS = [
    "EVEREST", "KILIMANJARO", "FUJI", "MATTERHORN", "DENALI", "ELBRUS", "ACONCAGUA",
    "RAINIER", "OLYMPUS", "APO", "PULAG", "KITANGLAD", "HALCON", "BANAHAW",
    "MAKILING", "TALINIS", "KANLAON", "MAYON", "IGLIT", "MALINDANG",
    "BLANC", "COOK", "WHITNEY", "SHASTA", "HOOD"
];

export const WEEKLY_GROUPS_ACCELERATED_RIVERS = [
    "AMAZON", "NILE", "MEKONG", "DANUBE", "THAMES", "RHINE", "VOLGA", "GANGES",
    "YANGTZE", "PASIG", "CAGAYAN", "AGNO", "ABRA", "AGUSAN", "BICOL",
    "MARIKINA", "CHICO", "TIGRIS", "EUPHRATES", "ZAMBEZI",
    "ORINOCO", "COLORADO", "SEINE", "YUKON", "CONGO"
];

export const ACCELERATED_WEEKLY_CATEGORIES = [
    { key: 'cars',        label: 'Car Brands',  names: WEEKLY_GROUPS_ACCELERATED_CARS },
    { key: 'birds',       label: 'Birds',       names: WEEKLY_GROUPS_ACCELERATED_BIRDS },
    { key: 'fish',        label: 'Fish',        names: WEEKLY_GROUPS_ACCELERATED_FISH },
    { key: 'butterflies', label: 'Butterflies', names: WEEKLY_GROUPS_ACCELERATED_BUTTERFLIES },
    { key: 'dogs',        label: 'Dog Breeds',  names: WEEKLY_GROUPS_ACCELERATED_DOG_BREEDS },
    { key: 'mountains',   label: 'Mountains',   names: WEEKLY_GROUPS_ACCELERATED_MOUNTAINS },
    { key: 'rivers',      label: 'Rivers',      names: WEEKLY_GROUPS_ACCELERATED_RIVERS },
];

export const WEEKLY_GROUPS_ACCELERATED = WEEKLY_GROUPS_ACCELERATED_CARS;
