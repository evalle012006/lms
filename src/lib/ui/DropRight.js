...
function DropRight({ label = "", icon, dropdownIcon = true, disabled, items, onChange }) {
  ...
  return (
    <>
        <div className="dropdown inline-block relative">
          ...
          <ul className={`${disabled ? '' : 'dropdown-menu'}  absolute bottom-10 left-20 hidden text-gray-700 pt-1 z-[100]`}>
            {
