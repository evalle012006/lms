        ...
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black bg-opacity-60 p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <div className="px-6 py-5 space-y-5">
                    ...
                    {/* ── Client Biometric Verification ──────────────────── */}
                    <div>
                        <p className="text-sm font-semibold text-gray-700 mb-3">
                            Client Identity Verification
                        </p>
                        {loan.clientBiometricVerified ? (
                            <div className="flex items-center gap-3 p-4 bg-green-50
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-green-600 mt-0.5">
                                        {loan.fullName || loan.clientName} confirmed via fingerprint
                                    </p>
                                    {loan.clientBiometricVerifiedAt && (
                                        <p className="text-xs text-green-500 mt-0.5">
                                            {moment(loan.clientBiometricVerifiedAt).format('MMM D, YYYY h:mm A')}
                                        </p>
                                    )}
                                </div>
                                <div className="flex-shrink-0 flex items-center gap-1 px-2 py-1
                            ...
                            <div className="flex items-center gap-3 p-4 bg-amber-50
                                ...
                                <div className="w-10 h-10 rounded-full bg-amber-100 flex items-center
                                    justify-center flex-shrink-0">
                                    <svg className="w-5 h-5 text-amber-600" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round"
                                            strokeWidth={1.5}
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-amber-600 mt-0.5">
                                        Client biometric was not confirmed at disbursement
                                    </p>
                                </div>
                            </div>
                        )}
