                ...
                <React.Fragment>
                    <div className="flex flex-col items-center font-proxima">
                        <div className="rounded-full flex items-center justify-center mx-auto group">
                            ...
                            <Avatar name={`${client.lastName}, ${client.firstName}`} src={client.profile ? client.imgUrl : placeholder.src} className={`${client.profile ? 'p-32 px-36' : 'p-12'} `} shape={`${client.profile ? 'square' : 'circle'}`} />
