...
// Gracefully handles missing URLs (shows placeholder + "Not uploaded").
const PhotoCard = ({ label, sublabel, url }) => {
            ...
            <div className="flex flex-col gap-1.5">
                <button
                    ...
                    className={`w-full aspect-square rounded-xl overflow-hidden border
                        ...
                        url
                            ? 'border-gray-200 hover:border-blue-400 cursor-zoom-in'
            ...
            {open && url && (
                ...
                >
                    <button
                        type="button"
                        onClick={() => setOpen(false)}
                        className="absolute top-4 right-4 p-2 bg-white bg-opacity-20
                            text-white rounded-full hover:bg-opacity-30"
                    >
                    ...
                    <p className="absolute bottom-4 left-0 right-0 text-center
                        ...
                        {label}{sublabel ? ` · ${sublabel}` : ''} — tap outside to close
                    </p>
                </div>
            )}
        </>
