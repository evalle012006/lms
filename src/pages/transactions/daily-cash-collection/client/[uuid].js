                ...
                if ((cc?.transferred == true && cc.transferredDate == currentDate) || ((cc?.transfer == true && cc.transferDate == currentDate) && cc?.current?.length == 0)) {
                    ...
                    if (cc.status === "tomorrow" || cc.status === "pending") {
                        ...
                        if (type !== 'filter' && cc?.draftCollection?.length > 0) {
                            ...
                            collection.mcbuReturnAmt = (draftCC.mcbuReturnAmt && draftCC.mcbuReturnAmt) ? draftCC.mcbuReturnAmt : 0;
                            ...
                            collection.dcmc = draftCC.dcmc ? draftCC.dcmc : false;
                                                    ...
                                                    <React.Fragment>
                                                        {(!isWeekend && !isHoliday && currentUser.role.rep > 2 && !groupSummaryIsClose) && (
                                                            <div className='flex flex-row p-2 justify-end'>
                                                                {(data && data.length > 0) && <ActionDropDown origin="cash-collection" data={cc} index={index} options={dropDownActions} dataOptions={{ filter: filter, prevDraft: prevDraft, editMode: editMode, currentMonth: currentMonth, last5DaysOfTheMonth: last5DaysOfTheMonth }} />}
                                                            </div>
                                                        )}
                                                    </React.Fragment>
                                                </td>
