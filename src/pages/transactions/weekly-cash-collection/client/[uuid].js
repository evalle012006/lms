                                    ...
                                    {data && data.map((cc, index) => {
                                        ...
                                        return (
                                            <tr key={index} className={`w-full hover:bg-slate-200 border-b border-b-gray-300 font-proxima 
                                                ...
                                                <th className="p-2 text-center">{(cc.status !== 'totals' && cc.clientId) && <CheckBox size={"md"} value={cc.selected} onChange={() => handleSelectRow(index)} />}</th>
                                                    ...
                                                    <React.Fragment>
                                                        {(!isWeekend && !isHoliday && currentUser.role.rep > 2 && !groupSummaryIsClose) && (
                                                            <div className='flex flex-row p-2'>
                                                                ...
                                                                {(!cc.advance && (cc.status == 'completed' && !prevDraft && (cc.remarks && cc.remarks.value == 'reloaner')) || (cc.status === 'completed' && !cc.remarks)) && <ArrowPathIcon className="w-5 h-5 mr-6" title="Reloan" onClick={(e) => handleReloan(e, cc)} />}
